\documentclass[answer=true,countunit=chapter,sheetsize=A4,paperprint=double,scoretable]{simplexam}
...
\chapter{判断题：本大题共4小题，每小题5分，共20分。判断下列各题，正确的在题后括号内打\ding{52}，错的打\ding{56}。}
...
\chapter{选择题：本大题共4小题，每小题10分，共40分。在每小题给出的四个选项中，只有一项是符合题目要求的。}

\includequestions[random=3]{questionlibb}%[random=3]


\chapter{填空题：本题共4小题，每小题5分，共20分。}
