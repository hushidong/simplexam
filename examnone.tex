\documentclass[answer=true,countunit=none,sheetsize=A4,paperprint=double,scoretable]{simplexam}
...
\includequestions[random=2]{questionlibb}%[random=3]
...
\includequestions[random=1]{questionlibc}%[random=3]


\includequestions[random=2]{questionlibd}%
